...
~/soft/iqtree-2.2.0-Linux/bin/iqtree2 --alisim alignment_$tr -m JC+G4{uniform} --indel 0.01,0.01 --indel-size POW{1.7/30},POW{1.7/30} --no-unaligned -t $file --length '$len' -af fasta -seed $myrand
