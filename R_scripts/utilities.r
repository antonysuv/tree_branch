...
ggplot(z.df,aes(x=branch_length,y=dencity))+
...
dd = get_wrapped("test_simulation.Y.txt","brls.predicted.cnn.sqrt.txt","brls.predicted.cnn.reg.sqrt.txt","brls.predicted.mlp.sqrt.txt","brls.predicted.mlp.reg.sqrt.txt","ML_all.tre")
