...
def build_CNNVI_brl(X_train,Y_train,conv_pool_n,droput_rates,batch_sizes):
    ...
    filter_s=[1024,1024,1024,128,128,128,128,128]
...
def main():
    ...
    #Regression BL
    #Run model
    model_cnnvi_reg=build_CNNVI_brl(X_train=X_train,Y_train=Y_train,conv_pool_n=6,droput_rates=0.15,batch_sizes=32)
